      ...
      >
        ...
        <motion.div variants={item}>
          <p
            ...
            style={{ color: "#ddeedd", fontFamily: "'Cormorant Garamond', serif" }}
          >
            {t("weds", "संग")}
          </p>
        </motion.div>
          ...
          {[
            ...
            >
              <div
                ...
                style={{ color: "#fafaee", fontFamily: "'Jost', sans-serif", letterSpacing: "0.06em" }}
              >
                {String(unit.value).padStart(2, "0")}
              </div>
              <div className="w-6 h-px mx-auto my-2" style={{ background: "rgba(221,238,221,0.5)" }} />
              <div
